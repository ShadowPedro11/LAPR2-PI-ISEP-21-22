...
public class SNSUserStore implements Serializable {
     ...
     */
    private ArrayList<SNSUserDto> userListToVerify;
    ...
    private boolean validateSex(SNSUserDto user) {
        return (user.getSex().equals("Masculine") || user.getSex().equals("Femenine") || user.getSex().equals("N/A"));
    }
     ...
     */
    private void addUsersToSystem(SNSUser user) {
        userList.add(user);
    }
}

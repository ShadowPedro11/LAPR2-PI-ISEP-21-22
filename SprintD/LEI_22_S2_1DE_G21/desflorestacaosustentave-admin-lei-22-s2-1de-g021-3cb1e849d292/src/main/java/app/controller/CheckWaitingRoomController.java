...
import app.ui.console.CheckWaitingRoomUI;
...
public class CheckWaitingRoomController {
    ...
    public WaitingRoom waitingRoomf = company.getCurrentVC().getWaitingRoom();
    ...
    public List<SNSUserDto> getWaitingRoom(VaccinationCenter currentVC) {
        List<SNSUser> waitingRoom = waitingRoomf.getWaitingRoom();

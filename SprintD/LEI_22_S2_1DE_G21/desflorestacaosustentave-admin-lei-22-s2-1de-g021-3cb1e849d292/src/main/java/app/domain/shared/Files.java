...
public class Files {
    ...
    public static final String FILE_VACCINE_SCHEDULE_STORE = "vaccine_schedule_store.bin";

    public static final String FILE_COMPANY = "company.bin";

    public static final String FILE_VACCINE_EVENT = "vaccine_event.bin";
}

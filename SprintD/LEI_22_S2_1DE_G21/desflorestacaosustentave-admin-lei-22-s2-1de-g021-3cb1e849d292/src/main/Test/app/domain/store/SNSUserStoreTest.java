...
class SNSUserStoreTest {
    ...
    SNSUserDto user1 = new SNSUserDto("Alex","Masculino","2003/4/2","Francos",123456789,"alex@gmail.com",123456789,12345678);
    SNSUserDto user2 = new SNSUserDto("Tiago","Masculino","2003/4/15","Trofa",234567890,"tiago@gmail.com",987654321,12312312);
    SNSUserDto user3 = new SNSUserDto("Pedro","Masculino","2003/7/5","ISEP",345678901,"pedro@gmail.com",987987987,87654321);
    SNSUserDto user4 = new SNSUserDto("Jose","Masculino","2002/5/2","Azurara",456789012,"jose@gmail.com",123456780,12345679);
